 ...
 * Use the {@link QuizBuahFragmentThree#newInstance} factory method to
 * create an instance of this fragment.
 */
public class QuizBuahFragmentThree extends Fragment {
     ...
     * @return A new instance of fragment QuizBuahFragmentThree.
     */
    // TODO: Rename and change types and number of parameters
    public static QuizBuahFragmentThree newInstance(String param1, String param2) {
        QuizBuahFragmentThree fragment = new QuizBuahFragmentThree();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_quiz_buah_three, container, false);
        ...
        hintButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clickSound.start();
                optionTwo.startAnimation(animation);
            }
        });
